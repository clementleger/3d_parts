...
RAIL_ES_WIDTH = 16;
RAIL_ES_EXTRA = 2;
RAIL_ES_BOLT_DIAMETER = 3;
RAIL_ES_BOLT_HEAD_DIAMETER = 5;
...
RAIL_ES_LENGTH = RAIL_ES_HOLE_OFFSET + 5;
...
module rail_end_stop() {
    difference() {
        ...
        translate([RAIL_ES_LENGTH/2 - RAIL_ES_HOLE_OFFSET, 0, -RAIL_ES_FULL_HEIGHT/2]) #cylinder(d = RAIL_ES_BOLT_DIAMETER, h = RAIL_ES_FULL_HEIGHT);
        translate([RAIL_ES_LENGTH/2 - RAIL_ES_HOLE_OFFSET, 0, RAIL_ES_FULL_HEIGHT/2 - RAIL_ES_BOLT_HEAD_THICKNESS]) #cylinder(d = RAIL_ES_BOLT_HEAD_DIAMETER, h = RAIL_ES_BOLT_HEAD_THICKNESS);
    }
