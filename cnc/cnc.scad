...
XPI_CABLE_HOLDER_THICKNESS = 4;
/* Hole diameter for cables */
XPI_HOLE_DIAM = 10;
XPI_CABLE_HOLDER_BORDER_THICKNESS = 2;
...
module cable_holder()
{
    scale([1, 0.8, 1]) translate([0, - (XPI_CABLE_HOLDER_BORDER_THICKNESS + XPI_HOLE_DIAM/2), 0]) difference() {
        union() {
            cube([XPI_CABLE_HOLDER_HEIGHT, XPI_CABLE_HOLDER_BORDER_THICKNESS + XPI_HOLE_DIAM/2 , XPI_CABLE_HOLDER_THICKNESS]);
