...
/* Main holder */
difference() {
    roundedcube([ROD_WIDTH + 2 * HOLDER_THICKNESS, ROD_OVERLAP + HOLDER_THICKNESS, SUPPORT_TOTAL_HEIGHT], false, ROUNDING, "zmax");
...
difference() {
    union() {
        translate([-SCREW_PART_SIZE, 0, 0]) roundedcube([SCREW_PART_SIZE + HOLDER_THICKNESS, ROD_OVERLAP + HOLDER_THICKNESS, SCREW_PART_THICKNESS], false, ROUNDING, "zmax");
...
difference() {
    union() {
        /* Back screwing part */
        translate([0, ROD_OVERLAP, 0]) roundedcube([ROD_WIDTH + 2 * HOLDER_THICKNESS, SCREW_PART_SIZE + HOLDER_THICKNESS, SCREW_PART_THICKNESS], false, ROUNDING, "zmax");
