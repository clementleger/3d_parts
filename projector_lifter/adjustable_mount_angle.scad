...
difference() {
    union () {
    translate([SCREW_SIDE_WIDTH/2, 0, -(MOUNT_HEIGHT / 2 - MOUNT_THICKNESS / 2)]) roundedcube([SCREW_PART_SIZE - SCREW_SIDE_WIDTH , ROD_MOUNT_WIDTH, MOUNT_THICKNESS], true, ROUNDING, "z");
/* Chamfers */
